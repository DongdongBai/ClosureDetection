...
#   
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool1',69984,60)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv2',186624,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool2',43264,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv3',64896,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv4',64896,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv5',43264,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool5',9216,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc6',4096,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc7',4096,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteCosineDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc8',205,60)
    conv3Plot.LoadCosineDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
