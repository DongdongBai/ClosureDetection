...
#     
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv3',64896,8192,100)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv4',64896,8192,100)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv5',43264,5120,100)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
...
#     
    ...
    conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'pool5',9216,2560,100)
    conv3Plot.LoadEuclideanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'fc6',4096,1536,100)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
