...
#     
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv3',64896,8192,50)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv4',64896,8192,50)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'conv5',43264,5120,50)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
...
#     
    ...
    conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'pool5',9216,2560,50)
    conv3Plot.LoadEuclideanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Plot=CompressedPlotPresicionRecall.PlotPrecisionRecall("CityCenter",'fc6',4096,1536,50)
#     conv3Plot.LoadEuclideanDistance()
#     conv3Plot.FindMaxAndMinDistance()
#     conv3Plot.PlotPrecisionRecall()
#     Recall.append(conv3Plot.recall)
