...
#     conv3Hamming.WriteManhattanDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool1',69984,10)
...
#     conv3Hamming.WriteManhattanDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv2',186624,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool2',43264,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
# 
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv3',64896,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
# 
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv4',64896,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','conv5',43264,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
#  
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','pool5',9216,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
#     
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc6',4096,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
#     
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc7',4096,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
...
#     conv3Hamming.WriteManhattanDistance()
    ...
    conv3Plot=OriginalPlotPresicionRecall.PlotPrecisionRecall('CityCenter','fc8',205,10)
    conv3Plot.LoadManhattanDistance()
    conv3Plot.FindMaxAndMinDistance()
    conv3Plot.PlotPrecisionRecall()
    Recall.append(conv3Plot.recall)
